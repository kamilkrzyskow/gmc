...
let gGMC_DEBUG=window.location.hostname==="127.0.0.1";let gMarkCodeLineManager=new MarkCodeLineManager();window.addEventListener("DOMContentLoaded",_=>{gMarkCodeLineManager.setElement();gmcExpandNavigation();gmcExternalLinks();gmc404Redirect();});window.addEventListener("hashchange",_=>{gMarkCodeLineManager.setElement();})
